...
public class Console {
    ...
    final String file_pelanggan;
    final String file_pengemudi;
    Serial serial;

    public Console() {
        this.scan = new Scanner(System.in);
        this.baru = "Baru";
        this.process = "Sedang Diproses";
        this.finish = "Selesai";
        this.kembali = "Tidak Ditemukan";
        this.file_pelanggan = "data_pelanggan.dat";
        this.file_pengemudi = "data_pengemudi.dat";
    }
    ...
    public void addPelanggan(String nama, long no_telp, String alamat_pelanggan, long id_pelanggan,String username,String password) throws IOException{
        ...
        this.daftarPelanggan.add(tmp_pelanggan);
    }
    ...
    public void addPengemudi(String nama, long no_telp, long id_pengemudi,String username,String password) throws IOException{
        ...
        this.daftarPengemudi.add(tmp_pengemudi);
    }

    public Pengemudi getPengemudi(long idPengemudi){
        int panjang = this.daftarPengemudi.size();
